		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<form  method="POST" action="/login">
				<ul class="nav navbar-nav navbar-right" style="padding-top: 15px;">	
					...
					{{ csrf_field() }}				
					<li>
						<input required type="email" name="correo" placeholder="Correo" maxlength="50">
					</li>
					<li>
						<input required type="password" name="contra" maxlength="25" placeholder="Contraseña">
					</li>
					<li>
						<button type="submit" class="btn btn-primary" style="margin-top: 10px; margin-right: 5px;">Entrar</button>
					</li>
